                            ...
                            { 
                                using (BigRedEntities BR = new BigRedEntities())
                                {
                                    ...
                                    if (items.issue_issue_ID == 2)
                                    {
                                        ...
                                        msg = "Good morning!@@ Material delay is not resolved @ Line : " + lineInfo.line_name + " @ Material : " + items.material_id + "@ Responsible person : " + responsiblePersonInfo.Name + "@ Date : " + items.issueDate + " @ Thank You!";
                                    ...
                                    if (items.issue_issue_ID == 1)
                                    {
                                        ...
                                        msg = "Good morning!@@ Machine Breakdown is not resolved @ Line : " + lineInfo.line_name + " @ Machine : " + items.machine_machine_id + "@ Responsible person : " + responsiblePersonInfo.Name + "@ Date : " + items.issueDate + " @ Thank You!";
